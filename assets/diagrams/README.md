...
| `fig-03-service-topology` | 3.1 — One order across the services | The example-services chapter; deck §3 |
| `fig-04-instrumentation-layers` | 4.1 — Auto vs. custom vs. hybrid | Hybrid chapter (r2.0); deck |
| `fig-07-context-propagation` | 7.1 — traceparent across the Kafka hop | Custom spans chapter; deck |
